...
![MITRE ATT&CK Enterprise Framework matrix showing tactics like Initial Access, Execution, Persistence, and techniques under each category.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/115/attack-framework.png)
...
![Wireshark displaying TCP packet capture with source and destination IPs, protocol details, and hex data view.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/115/pcap-4444.png)
...
![Wireshark TCP stream showing commands for directory listing and user creation with net user and net localgroup commands.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/115/follow-sus.png)
