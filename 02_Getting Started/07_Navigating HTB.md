...
![Profile overview showing rank, progress, and ownership stats.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/77/htb_profile.jpg)
...
![Graph showing user, system, challenge owns, first bloods, and respect over a year; machine and challenge progress below.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/77/htb_profile_2.jpg)
...
![Team rankings showing points, users, systems, challenges, fortresses, and endgames.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/77/htb_rankings.jpg)
...
![Dashboard showing 914 online players, 1020 machine owns, and 618 challenge owns today.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/77/htb_main_1.jpg)
...
![Tracks: Beginner, Intro to Dante, Intro to Offshore, Active Directory 101.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/77/htb_tracks.jpg)
...
![Beginner Track progress: 82% complete, includes challenges Lame, Find The Easy Pass, Templated, Weak RSA.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/77/beginner_track.jpg)
...
![Machine Lab: Tenet (Medium, Linux) and Registry (Hard, Linux).](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/77/htb_machines_1.jpg)
...
![Active machines: Doctor, Academy, Laboratory; all easy difficulty.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/77/htb_machines_2.jpg)
...
![Academy machine: Easy difficulty, 4.6 rating, 6623 user owns, 5837 system owns.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/77/machine_page.jpg)
...
![Active challenges: 11 Reversing, 8 Stego, 12 Misc, 12 Web.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/77/htb_challenges.jpg)
...
![Context page: Entry point 10.13.37.12, progress tracker at 0%, lab reset status.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/77/htb_fortress_1.jpg)
...
![Ascension page: Entry point 10.13.38.20, progress tracker at 0%, lab reset status.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/77/htb_endgame_1.jpg)
...
![Dante Pro Lab overview with cowboy mascot, 14 machines, 27 flags, beginner difficulty, Level 1 penetration tester.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/77/htb_prolab_dante.jpg)
...
![Cyber Mayhem and Server Siege game modes, with icons of a hacker and a server.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/77/htb_battlegrounds.jpg)
